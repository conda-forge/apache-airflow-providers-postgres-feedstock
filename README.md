About apache-airflow-providers-postgres
=======================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/apache-airflow-providers-postgres-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12050&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/apache-airflow-providers-postgres-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `apache-airflow-providers-postgres` can be installed with:

```
conda install apache-airflow-providers-postgres
```

It is possible to list all of the versions of `apache-airflow-providers-postgres` available on your platform with:
