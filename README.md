About apache-airflow-providers-postgres-feedstock
=================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-postgres-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-postgres-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-postgres
# for installing globally
pixi global install apache-airflow-providers-postgres
```
...
It is possible to list all of the versions of `apache-airflow-providers-postgres` available on your platform:
...
```
pixi search apache-airflow-providers-postgres --channel conda-forge
```
